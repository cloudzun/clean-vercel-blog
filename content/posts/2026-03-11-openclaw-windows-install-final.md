...
Write-Host "Step 5: Installing OpenClaw (this may take 2-5 minutes)..." -ForegroundColor Cyan
$env:PATH = 'C:\Program Files\Git\bin;C:\Program Files\nodejs;' + $env:PATH
& "C:\Program Files\nodejs\npm.cmd" install -g openclaw@latest --ignore-scripts

# ===== 6. 验证 =====
Write-Host "Step 6: Verifying..." -ForegroundColor Green
...
| Git HTTPS 配置 | ✅ 完整（2 条） | ⚠️ 不完整（1 条） |
| npm 安装参数 | ✅ `--ignore-scripts` | ❌ 无参数 |
| 网络连接 | ✅ 稳定 | ⚠️ GitHub 超时 |
| 最终结果 | ✅ 成功 | ❌ 失败 |
